...
**Access:** http://radarr.local.infinity-node.win (port-free via Traefik) or http://radarr.local.infinity-node.win:7878 (direct)
...
1. Access: http://radarr.local.infinity-node.win (port-free) or http://radarr.local.infinity-node.win:7878 (direct)
...
4. Settings → Download Clients:
   - Add Deluge (VM 101): http://deluge.local.infinity-node.win:8112
   - Add NZBGet (VM 101): http://nzbget.local.infinity-node.win:6789
