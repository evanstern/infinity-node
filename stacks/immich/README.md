...
**Access:** http://immich.local.infinity-node.win (port-free via Traefik) or http://immich.local.infinity-node.win:2283 (direct)
...
1. **Access Web UI:** Navigate to http://immich.local.infinity-node.win (port-free) or http://immich.local.infinity-node.win:2283 (direct)
...
5. **Connect App to Server:**
   - Server URL: http://immich.local.infinity-node.win (port-free) or http://immich.local.infinity-node.win:2283 (direct)
