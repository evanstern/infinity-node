...
### Emby
1. Access Emby web UI: http://emby.local.infinity-node.com:8096
2. Settings → API Keys
...
1. Access service web UI (e.g., http://radarr.local.infinity-node.com:7878)
...
### Jellyseerr
1. Access Jellyseerr web UI: http://jellyseerr.local.infinity-node.com:5055
2. Settings → General → API Key
3. Copy the API key
