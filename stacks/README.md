...
1. **Access Portainer** on your VM (e.g., http://portainer-103.local.infinity-node.win or http://portainer-103.local.infinity-node.win:9000)
...
# Example:
./scripts/deploy-with-secrets.sh vaultwarden vm-103.local.infinity-node.win /home/evan/projects/infinity-node/stacks/vaultwarden
```
