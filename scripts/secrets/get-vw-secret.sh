...
# Examples:
#   # Get password
#   ./get-vw-secret.sh "portainer-api-token-vm-100" "shared"
#
#   # Get custom field
#   ./get-vw-secret.sh "portainer-api-token-vm-100" "shared" "url"
#
#   # Use in scripts
#   TOKEN=$(./get-vw-secret.sh "portainer-api-token-vm-100" "shared")
#   URL=$(./get-vw-secret.sh "portainer-api-token-vm-100" "shared" "url")
#
# Requirements:
...
if [ $# -lt 2 ]; then
    ...
    echo "" >&2
    echo "Examples:" >&2
    echo "  $0 \"portainer-api-token-vm-100\" \"shared\"" >&2
    echo "  $0 \"portainer-api-token-vm-100\" \"shared\" \"url\"" >&2
    exit 1
fi
